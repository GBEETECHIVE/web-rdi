...
export const impactPartnersNew = [
  {
...
export const concurrentSpeakers = [
  {
    day: "DAY-2",
    title: "CONCURRENT SESSION: Early Learning Opportunities",
    plenary:"CONCURRENT SESSION: Early Learning Opportunities (concurrent)",
    roles: [
      {
        role: "Chair",
        people: [
...
export const concurrentSpeakers2 = [{
    day: "DAY-2",
    title: "Roundtable on the Operationalization of the National ECD Policy Framework with Provincial Ministers and Other Government Officials Facilitated by Key ECD",
    plenary: "Roundtable on the Operationalization of the National ECD Policy Framework with Provincial Ministers and Other Government Officials Facilitated by Key ECD",
    roles: [
        {
            role: "Chair",
            people: [
...
export const plenarySpeakers = [
    ...
    roles: [
      {
        ...
        people: [
          {
            name: "Dr Zafar Mirza",
            org: "Former Federal Minister Health",
            role: "Keynote Speaker",
  ...
  {
    day: "DAY-2",
    plenary: "PLENARY 2: Research, Measurement & Accountability Systems",
    roles: [
      {
        role: "Chair",
        people: [
  ...
  {
    day: "DAY-2",
    plenary: "PLENARY 3: Caregivers' Mental Health & MH&PSS Integration",
    roles: [
      {
        role: "Chair",
        people: [
