      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-gray-600">
            Everything you need to know to plan your day and enjoy a meaningful
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              title: "Bilingual Event",
              desc: "Sessions available in English & Spanish",
              icon: (
                <svg
                  className="h-7 w-7"
                  fill="none"
            ...
            },
            {
              ...
              desc: "No cost to participate in the conference",
              icon: (
                <svg
                  className="h-7 w-7"
                  fill="none"
            ...
            },
            {
              ...
              desc: "Breakfast, lunch, and snacks included",
              icon: (
                <svg
                  className="h-7 w-7"
                  fill="none"
            ...
            {
              title: "Goodie Bags",
              desc: "Helpful items for mom & baby like diapers and wipes",
              icon: (
                <svg
                  className="h-7 w-7"
                  fill="none"
            ...
            {
              title: "Raffle Prizes",
              desc: "Chance to win items like car seats or strollers",
              icon: (
                <svg
                  className="h-7 w-7"
                  fill="none"
            ...
            },
            {
              ...
              desc: "Mindfulness, prenatal stretching & relaxation",
              icon: (
                <svg
                  className="h-7 w-7"
                  fill="none"
            ...
            },
            {
              ...
              desc: "Free screenings & access to low-cost services",
              icon: (
                <svg
                  className="h-7 w-7"
                  fill="none"
            ...
            },
            {
              ...
              desc: "Possible help getting to and from the conference",
              icon: (
                <svg
                  className="h-7 w-7"
                  fill="none"
            ...
            },
            {
              ...
              desc: "Possible childcare for other children during the event",
              icon: (
                <svg
                  className="h-7 w-7"
                  fill="none"
