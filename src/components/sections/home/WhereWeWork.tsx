        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              ...
              challenges and opportunities they present. Through our work, we
              aim to create thriving communities that are resilient, empowered,
              and equipped to overcome obstacles and embrace a future of
              prosperity.
            </p>
          </div>
