    ...
    <section>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 text-center">
        <h2 className="text-2xl sm:text-3xl font-semibold text-[#037536]">
          Únete a Nosotros para un Día de Aprendizaje y Apoyo
        </h2>
        <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
          Conéctate con expertos, aprende sobre salud materna y obtén valiosos
          conocimientos sobre el desarrollo infantil temprano.
        </p>
        <a
